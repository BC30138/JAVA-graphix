        ...
        if (a == 2) {
            ...
            try {
                for (i = 0; i < n; ++i) {
                    ...
                    g.drawLine(350 - (int) (coord[0] * 1.5 * mas[i] / 100), 300 - (int) (coord[1] * 1.5 * mas[i] / 100),
                            x, y);
            ...
            int coord[] = Coord(0);
            g.setColor(Color.blue);
            g.drawLine(350 - (int) (coord[0] * 1.5 * mas[0] / 100), 300 - (int) (coord[1] * 1.5 * mas[0] / 100), x, y);
        }
        if (a > 2) {
            g.setColor(Color.black);
            int x = 350, y = 300;
            for (i = 0; i < n; ++i) {
                g.setColor(Color.blue);
                int coord[] = Coord(i * grad);
                g.drawLine(350 - (int) (coord[0] * 1.5 * mas[i] / 100), 300 - (int) (coord[1] * 1.5 * mas[i] / 100), x,
                        y);
                g.setColor(Color.red);
                g.drawLine(350 - (int) (coord[0] * 1.5 * mas[i] / 100), 300 - (int) (coord[1] * 1.5 * mas[i] / 100),
                        350, 300);
